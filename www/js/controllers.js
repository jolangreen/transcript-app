...
starter.controller('AppCtrl', function($scope, $ionicModal, $timeout, $ionicSlideBoxDelegate, $ionicScrollDelegate, $location, AuthenticationService, FlashService) {
...
starter.controller('ProfileCtrl', function($scope) {
...
starter.controller('OrderController', function($scope, $http, $filter, $timeout, $ionicScrollDelegate, $anchorScroll, $ionicSlideBoxDelegate) {    
...
starter.controller('HomeController', function($scope, UserService, $rootScope) {
...
starter.controller('LoginController', function($scope, $location, AuthenticationService, FlashService) {
  var vm = this;
...
starter.controller('RegisterController', function($scope, UserService, $location, $rootScope, FlashService) {
  var vm = this;
